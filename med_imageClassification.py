...
with col1:
    st.markdown('<a href="https://maintrying.streamlit.app/" target="_blank"><button style="width: 30px;">🏠 Home</button></a>', unsafe_allow_html=True)

with col2:
    st.markdown('<a href="https://your-disease-prediction-deployment-link.com" target="_blank"><button style="width: 30px;">🩺 Disease Prediction</button></a>', unsafe_allow_html=True)

with col3:
    st.markdown('<a href="https://your-outpatient-prediction-deployment-link.com" target="_blank"><button style="width: 30px;">📅 Outpatient Prediction</button></a>', unsafe_allow_html=True)

with col4:
    st.markdown('<a href="https://your-bed-occupancy-deployment-link.com" target="_blank"><button style="width: 30px;">🛏 Bed Occupancy Prediction</button></a>', unsafe_allow_html=True)
