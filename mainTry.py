...
if st.session_state.page == "Homepage":
    ...
    st.markdown("**3️⃣ Predicting Outpatient Attendance** - AI can forecast patient volume.  👉 [Learn more about outpatient prediction](https://www.healthcareitnews.com/news/how-ai-can-improve-patient-flow-and-hospital-operations)")

    st.image("bed_occupancy.jpeg", width=300)
    st.markdown("**4️⃣ Bed Occupancy Prediction** - AI predicts hospital bed demand.  👉 [See more about bed occupancy prediction](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0266612)")
